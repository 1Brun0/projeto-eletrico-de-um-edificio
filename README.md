⚡ Projeto de Instalações Elétricas Residenciais – TCC
...
Aplicar as normas técnicas para garantir a segurança, a eficiência e as previsões do projeto elétrico residencial;

Desenvolver um sistema elétrico completo, normatizado e compatível com a infraestrutura de infraestrutura;
...
Dimensionamento de condutores, interruptores e eletrodutos com base na NBR 5410;

Aplicação de fatores de exigência e verificação de critérios de proteção.
...
Visualização dos circuitos, elásticos de cabos e proteções.
...
Abordagem voltada para eficiência energética e conforto visual.
...
E-mail: brunhenriq17@gmail.com

LinkedIN: https://www.linkedin.com/in/bruno-henriq/
